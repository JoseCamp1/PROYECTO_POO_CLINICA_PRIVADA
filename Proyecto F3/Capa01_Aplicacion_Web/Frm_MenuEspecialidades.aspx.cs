...
{
    public partial class Frm_Especialidades : System.Web.UI.Page
    {
        //CARGAR DATOS
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                string condicion = string.Format("NOMBRE_ESPECIALIDAD LIKE '%{0}%'", txtNombre.Text);
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            Session.Remove("id_del_especialidad");
            //redireccionamos al otro formulario
            Response.Redirect("Frm_NuevaEspecialidad.aspx");
        }
        ...
        protected void InkModificar_Command(object sender, CommandEventArgs e)
        {
            ...
            Session["id_del_especialidad"] = e.CommandArgument.ToString();
        ...
        protected void InkEliminar_Command(object sender, CommandEventArgs e)
        {
            ...
            try
            {
                especialidad = logica.ObtenerEspecialidad(id);
                if (especialidad.Existe)
                {
                    if (logica.EliminarEspecialidad(especialidad) > 0)
                    {
