<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Frm_NuevoPuestoTrabajo.aspx.cs" Inherits="Capa01_Aplicacion_Web.Frm_NuevoPuestoTrabajo" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Nuevo Puesto de Trabajo</title>
...
<body>
    <header class="bg-success text-light">
                <div class="container">
                    <h1 class="p-3 text-center">Nuevo/Modificar Puesto de Trabajo</h1>
                </div>        
    </header>
