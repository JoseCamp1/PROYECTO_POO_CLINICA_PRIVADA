<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Frm_MenuUsuarioSistema.aspx.cs" Inherits="Capa01_Aplicacion_Web.Frm_MenuUsuarioSistema" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Menu Usuario del Sistema</title>
...
<body>
    <header class="bg-success text-light">
        <div class="container">
            <h1 class="p-3 text-center">Usuario del Sistema</h1>
        </div>        
    </header>
    <form id="form1" runat="server" class="container text-center">
        <div class="form-inline mt-3">
            <asp:Label ID="Label2" runat="server" Text="Correo del Usuario:" CssClass="mr-2"></asp:Label>
        ...
        <div class="gridview mt-3">
            <asp:GridView ID="grdLista" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" EmptyDataText="No existen registros para mostrar" ForeColor="Black" GridLines="Vertical" Width="100%" PageSize="8" OnPageIndexChanging="grdLista_PageIndexChanging1">
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="InkModificar" runat="server" CommandArgument='<%# Eval("IdUsuarioSistema").ToString() %>' CommandName="Modificar" OnCommand="InkModificar_Command">Modificar</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="InkEliminar" runat="server" CommandArgument='<%# Eval("IdUsuarioSistema").ToString() %>' CommandName="Eliminar" OnCommand="InkEliminar_Command">Eliminar</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="IdUsuarioSistema" HeaderText="ID" />
